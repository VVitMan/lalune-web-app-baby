        ...
        <div className="flex justify-center items-center w-full  min-h-screen bg-base-50 px-5 py-5">
            ...
            rounded-md flex justify-between items-stretch px-5 xl:px-5 py-5">
                ...
                <div className="mx-auto w-full lg:w-1/2 md:p-10 py-5 md:py-0">
                    <h1 className="text-center text-2xl sm:text-3xl font-semibold text-error">
                        Dispel
                    </h1>
                        ...
                        <div className="mx-auto w-full sm:max-w-md md:max-w-lg flex flex-col gap-5">
                            <div className="flex flex-col sm:flex-row gap-3">
                                <input
                                    ...
                                    className="input input-bordered input-error w-full max-w-xs text-black placeholder:text-black/60"
                                />
                                <input
                                    type="text"
                            ...
                            <input
                                type="date"
                                className="input input-bordered input-error w-full text-black/60"
                            />

                            {/* Zodiac */}
                            <select defaultValue="Pick a Zodiac" className="select select-error text-black/60">
